...
const val CaptchaLogin = "PhoneCaptchaLogin_INSTANCE"
const val EmailLogin = "EmailLoginFragment_INSTANCE"
const val PasswordLogin = "PhonePasswordLogin_INSTANCE"
...
fun <T : Fragment> gotoFragmentPage(
    ...
    start.requireActivity().supportFragmentManager.apply {
        ...
        beginTransaction().apply {
            hide(start)
            if (target == null) {
                add(R.id.entrance_fragment_container, callback(), tag)
